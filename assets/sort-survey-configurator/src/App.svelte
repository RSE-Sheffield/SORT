        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="/"
                   onclick={(e)=> {e.preventDefault(); e.stopPropagation(); page = 0;}}>Main</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/" onclick={(e)=>{e.preventDefault(); e.stopPropagation(); page = 1;}}>
                    Consent demography
                </a>
            </li>
        </ul>
