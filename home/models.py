...
class UserManager(BaseUserManager):
    def create_user(self, first_name, last_name, email, organisation, password=None):
        ...
        user = self.model(email=email, first_name=first_name, last_name=last_name, organisation=organisation)
    ...
    def create_superuser(self, email, first_name, last_name, organisation, password=None):
        user = self.create_user(email=email, first_name=first_name,
            last_name=last_name, organisation=organisation, password=password)
        user.is_staff = True
